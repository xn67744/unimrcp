...
MRCP_PLUGIN_DECLARE(mrcp_engine_t*) mrcp_plugin_create(apr_pool_t *pool)
{
	...
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> mrcp_plugin_create");
...
static apt_bool_t demo_recog_engine_destroy(mrcp_engine_t *engine)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_engine_destroy");
...
static apt_bool_t demo_recog_engine_open(mrcp_engine_t *engine)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_engine_open");
	demo_recog_engine_t *demo_engine = engine->obj;
	if(demo_engine->task) {
		apt_task_t *task = apt_consumer_task_base_get(demo_engine->task);
 		apt_task_start(task);
...
static apt_bool_t demo_recog_engine_close(mrcp_engine_t *engine)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_engine_close");
	demo_recog_engine_t *demo_engine = engine->obj;
	if(demo_engine->task) {
		apt_task_t *task = apt_consumer_task_base_get(demo_engine->task);
...
static mrcp_engine_channel_t* demo_recog_engine_channel_create(mrcp_engine_t *engine, apr_pool_t *pool)
{
	...
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_engine_channel_create");
...
{
	/* nothing to destrtoy */
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_destroy");
	return TRUE;
}
...
static apt_bool_t demo_recog_channel_open(mrcp_engine_channel_t *channel)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_open");
	if(channel->attribs) {
		/* process attributes */
...
static apt_bool_t demo_recog_channel_close(mrcp_engine_channel_t *channel)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_close");
...
static apt_bool_t demo_recog_channel_request_process(mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_request_process");
	return demo_recog_msg_signal(DEMO_RECOG_MSG_REQUEST_PROCESS,channel,request);
}

/** Process RECOGNIZE request £¨ÒôÆµÖ¡»î¶¯¼ì²âÆ÷ÅäÖÃ£©*/
static apt_bool_t demo_recog_channel_recognize(mrcp_engine_channel_t *channel, mrcp_message_t *request, mrcp_message_t *response)
{
	...
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_recognize");
...
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_stop");
	/* process STOP request */
	demo_recog_channel_t *recog_channel = channel->method_obj;
...
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_timers_start");
	demo_recog_channel_t *recog_channel = channel->method_obj;
	recog_channel->timers_started = TRUE;
...
static apt_bool_t demo_recog_channel_request_dispatch(mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	...
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_channel_request_dispatch");
...
static apt_bool_t demo_recog_stream_destroy(mpf_audio_stream_t *stream)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_stream_destroy");
	return TRUE;
}
...
static apt_bool_t demo_recog_stream_open(mpf_audio_stream_t *stream, mpf_codec_t *codec)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_stream_open");
	return TRUE;
}
...
static apt_bool_t demo_recog_stream_close(mpf_audio_stream_t *stream)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_stream_close");
	return TRUE;
}
...
static apt_bool_t demo_recog_start_of_input(demo_recog_channel_t *recog_channel)
{
	...
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_start_of_input");
...
static apt_bool_t demo_recog_result_load(demo_recog_channel_t *recog_channel, mrcp_message_t *message)
{
	...
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_result_load");
...
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_recognition_complete");
	mrcp_recog_header_t *recog_header;
...
static apt_bool_t demo_recog_stream_write(mpf_audio_stream_t *stream, const mpf_frame_t *frame)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_stream_write");
...
static apt_bool_t demo_recog_msg_signal(demo_recog_msg_type_e type, mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_msg_signal");
...
static apt_bool_t demo_recog_msg_process(apt_task_t *task, apt_task_msg_t *msg)
{
	apt_log(RECOG_LOG_MARK, APT_PRIO_DEBUG, "demo method ==> demo_recog_msg_process");
